...
@Component({
  selector: 'app-infragistics-editing',
  templateUrl: './infragistics-editing.component.html',
  styleUrls: ['./infragistics-editing.component.css','./infragistics-editing.scss']
})
export class InfragisticsEditingComponent {
